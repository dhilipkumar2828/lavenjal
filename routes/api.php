...
Route::group([
  ...
  Route::get('order_details/{order_id}', [OrderController::class , 'order_details']);
  Route::get('distributor_orderLists', [OrderController::class , 'distributor_orderLists']);
  Route::get('distributor_orderlists', [OrderController::class , 'distributor_orderLists']);
  Route::get('distributor_accepted_orders', [OrderController::class , 'distributor_accepted_orders']);
  Route::get('distributor_orderDetails/{order_id}', [OrderController::class , 'distributor_orderDetails']);
  Route::get('distributor_orderdetails/{order_id}', [OrderController::class , 'distributor_orderDetails']);
  ...
  Route::post('distributor_orderstatus', [OrderController::class , 'deliveryboy_order_status']);
  ...
  Route::patch('update_user_address/{id}', [OrderController::class , 'update_user_address']);
