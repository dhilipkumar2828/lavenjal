      ...
      <div class="card-body">
        <table class="table table-bordered table-left" style="width:100%">
          ...
          <tr>
                ...
                <td>{{$retailer_view->user_id}}</td>
              </tr>
            <tr>
              <th>
                <h6><strong>Name of the Shop</strong></h6>
              </th>
              <td>{{$retailer_view->name_of_shop}}</td>
            </tr>
            <!--<tr>-->
            <!--  <th>-->
            <!--    <h6><strong>Nature of the shop</strong></h6>-->
            <!--  </th>-->
            <!--  <td>{{$retailer_view->nature_of_shop}}</td>-->
            <!--</tr>-->
            <!--<tr>-->
            <!--    <th>-->
            <!--      <h6><strong>Ownership Status</strong></h6>-->
            <!--    </th>-->
            <!--    <td>{{$retailer_view->ownership_type}}</td>-->
            <!--  </tr>-->
            <tr>
              <th>
                <h6><strong>Name of the owner</strong></h6>
              </th>
              <td>{{$retailer_view->name_of_owner}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>Contact No</strong></h6>
              </th>
              <td>{{$retailer_view->owner_contact_no}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>Email Id</strong></h6>
              </th>
              <td>{{$retailer_view->owner_email}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>Pincode</strong></h6>
              </th>
              <td>{{$retailer_view->pincode}}</td>
            </tr>
                        <tr>
              <th>
              ...
              <td>
                 @if(!empty($retailer_view->business_certificate))
                <form action="{{url('download_file').'/'.$retailer_view->id}}" method="GET">
                  @csrf
                  <input type="hidden" value="business_certificate" name="type">
                <button type="submit" class="btn btn-outline-info download_file" data-id="{{$retailer_view->id}}"><i
            ...
            <!--  </th>-->
            <!--  <td>{{$retailer_view->delivery_type}}</td>-->
            <!--</tr>-->
            <!--<tr>-->
            <!--  <th>-->
            <!--    <h6><strong>No of delivery persons</strong></h6>-->
            <!--  </th>-->
            <!--  <td>{{$retailer_view->no_of_delivery_boys}}</td>-->
            <!--</tr>-->
            <!-- <tr>
            ...
            <!--  </th>-->
            <!--  <td><img src="{{asset($retailer_view->shop_photo)}}" alt="" style="width:100%"></td>-->
            <!--</tr>-->
          </tbody>
        </table>
          ...
          <table class="table table-bordered table-left" style="width:100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    {{$retailer_view->assign_sales_rep}}
                </td>
              </tr>
              <tr>
                <th>
