                ...
                <table class="table table-bordered table-left" style="width:100%">
                    ...
                    <tbody>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" placeholder=""
                                        aria-label="default input example" value="{{empty(old('name_of_shop'))?$retailer_edit->name_of_shop : old('name_of_shop')}}" name="name_of_shop" >
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="{{empty(old('name_of_owner'))?$retailer_edit->name_of_owner : old('name_of_owner')}}"  name="name_of_owner" placeholder=""
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control " type="text" value="{{empty(old('owner_contact_no'))?$retailer_edit->owner_contact_no : old('owner_contact_no')}}" name="owner_contact_no" placeholder=""
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="{{empty(old('owner_email'))?$retailer_edit->owner_email : old('owner_email')}}" name="owner_email" placeholder=""
                                        aria-label="default input example" value="">
                                </div>
                            ...
                            <td>
                                <div>
                                    <textarea class="form-control" type="text" placeholder=""
                                        aria-label="default input example" rows="3" name="full_address" cols="3">{{empty(old('full_address'))?$retailer_edit->full_address : old('full_address')}}</textarea>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="{{empty(old('pincode'))?$retailer_edit->pincode : old('pincode')}}" name="pincode" placeholder=""
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="{{empty(old('aadhar_number'))?$retailer_edit->aadhar_number : old('aadhar_number')}}" name="aadhar_number" placeholder=""
                                        aria-label="default input example" onkeypress="return isNumber(event)" >
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="{{empty(old('gst_no'))?$retailer_edit->gst_no : old('gst_no')}}" name="gst_no" placeholder=""
                                        aria-label="default input example" >
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{!empty($retailer_edit->business_certificate)?url($retailer_edit->business_certificate):''}}">
                                  <span class="file_name m-5">View file</span>
                                  </a>
                                 <!--<span class="file_name">{{!empty($retailer_edit->business_certificate)?$retailer_edit->business_certificate:''}}</span>-->
                            </td>
                        </tr>
                        <!--<tr>-->
                        <!--    <th>-->
                        ...
                        <table class="table table-bordered table-left" style="width:100%">
                            <tbody>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="lat" placeholder=""
                                                aria-label="default input example" value="{{empty(old('lat'))?$retailer_edit->lat : old('lat')}}">
                                        </div>
                                       <span class="lat"></span>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="lang" placeholder=""
                                                aria-label="default input example" value="{{empty(old('lang'))?$retailer_edit->lang : old('lang')}}">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="landmark" placeholder=""
                                                aria-label="default input example" value="{{empty(old('landmark'))?$retailer_edit->landmark : old('landmark')}}">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" value="{{empty(old('area_sqft'))?$retailer_edit->area_sqft : old('area_sqft')}}" name="area_sqft" placeholder=""
                                                aria-label="default input example" >
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" value="{{empty(old('storage_capacity'))?$retailer_edit->storage_capacity : old('storage_capacity')}}" name="storage_capacity" placeholder=""
                                                aria-label="default input example" >
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text"  value="{{empty(old('twenty_ltres_sold_now'))?$retailer_edit->twenty_ltres_sold_now : old('twenty_ltres_sold_now')}}" name="twenty_ltres_sold_now" placeholder=""
                                                aria-label="default input example">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" value="{{empty(old('selling_jars_weekly'))?$retailer_edit->selling_jars_weekly : old('selling_jars_weekly')}}" name="selling_jars_weekly" placeholder=""
                                                aria-label="default input example">
                                        </div>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="pet_bottle_sold_now" placeholder=""
                                                aria-label="default input example" value="{{empty(old('pet_bottle_sold_now'))?$retailer_edit->pet_bottle_sold_now : old('pet_bottle_sold_now')}}">
                                        </div>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="additional_info" placeholder=""
                                                aria-label="default input example" value="{{empty(old('additional_info'))?$retailer_edit->additional_info : old('additional_info')}}">
                                        </div>
                                ...
                                <tr>
									...
									<select class="single-select" name="assign_sales_rep">
											...
											@foreach($sales_rep as $sale)
                                                <option value="{{$sale->id}}" {{($retailer_edit->assign_sales_rep  == $sale->id || old('assign_sales_rep') == $sale->id) ? 'selected' :''}}>{{$sale->name}}</option>
                                            @endforeach
										</select>
                                ...
                                <tr>
									...
									<select class="single-select" name="assigned_distributor">
											...
											@foreach($distributors as $distributor)
                                                <option value="{{$distributor->id}}" {{$retailer_edit->assigned_distributor == $distributor->id ? 'selected' :''}}>{{$distributor->name}}</option>
                                            @endforeach
										</select>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <select class="form-select me-2" name="status">
                                            <option value="">-select-</option>
                                            <option value="1" {{ $retailer_edit->status == '1' ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{ $retailer_edit->status == '0' ? 'selected' : '' }}>Inactive</option>
...
<script type="text/javascript">
            ...
            $.ajax({
                url: "{{route('retailer.update',$retailer_edit->id)}}",
                type:'POST',
                  processData: false,
                contentType: false,
                data: formData,
