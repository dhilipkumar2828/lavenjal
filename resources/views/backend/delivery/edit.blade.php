                ...
                <table class="table table-bordered table-left" style="width:100%">
                    ...
                    <tbody>
                            ...
                            <td>
                                <div>
                                    <input class="form-control mb-3" type="text" placeholder=""
                                        aria-label="default input example" value="{{$delivery_edit->name_of_shop}}" id="name_of_shop" name="name_of_shop" >
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <!--<input class="form-control mb-3" type="text" value="{{$delivery_edit->nature_of_shop}} " placeholder=""-->
                                    <!--    aria-label="default input example" name="nature_of_shop" >-->
                                    
                                    <select class="form-control" name="nature_of_shop">
                                        <option value="">Select nature</option>
                                        <option value="Super Market" {{$delivery_edit->nature_of_shop == "Super Market" ? 'selected' : ''}} >Super Market</option>
                                        <option value="General Store" {{$delivery_edit->nature_of_shop == "General Store" ? 'selected' : ''}}>General Store</option>
                                        <option value="Bakery" {{$delivery_edit->nature_of_shop == "Bakery" ? 'selected' : ''}}>Bakery</option>
                                        <option value="Others" {{$delivery_edit->nature_of_shop == "Others" ? 'selected' : ''}}>Others</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"  name="ownership_type"
                                            id="flexRadioDefault1" value="Proprietorship"   {{ ($delivery_edit->ownership_type || old('ownership_type')) == 'Proprietorship' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"  name="ownership_type"
                                            id="flexRadioDefault2" value="Partnership" {{ $delivery_edit->ownership_type == 'Partnership' ? 'checked' : '' }}>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control mb-3" type="text" value="{{empty(old('name_of_owner'))?$delivery_edit->name_of_owner : old('name_of_owner')}}"  name="name_of_owner" placeholder=""
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control mb-3" type="text" value="{{empty(old('owner_contact_no'))?$delivery_edit->owner_contact_no :old('owner_contact_no') }} " name="owner_contact_no" placeholder=""
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control mb-3" type="text" value="{{empty(old('owner_email'))?$delivery_edit->owner_email : old('owner_email')}} " name="owner_email" placeholder=""
                                        aria-label="default input example" value="">
                                </div>
                            ...
                            <td>
                                <div>
                                    <textarea class="form-control mb-3" type="text" placeholder=""
                                        aria-label="default input example" rows="3" name="full_address" cols="3">{{empty(old('full_address'))?$delivery_edit->full_address :old('full_address')}} </textarea>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control mb-3" type="text" value="{{empty(old('pincode'))?$delivery_edit->pincode :old('pincode') }}" name="pincode" placeholder=""
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control mb-3" type="text" value="{{empty(old('aadhar_number'))?$delivery_edit->aadhar_number :old('aadhar_number')}}" name="aadhar" placeholder=""
                                        aria-label="default input example" onkeypress="return isNumber(event)" >
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <!--<input class="form-control mb-3" type="text" value="{{$delivery_edit->delivery_type}} " name="delivery_type" placeholder=""-->
                                    <!--    aria-label="default input example" value="">-->
                                    
                                       <select class="form-control" name="delivery_type">
                                        <option value="">Select facility</option>
                                        <option value="2 Wheeler" {{$delivery_edit->delivery_type == "2 Wheeler" ? 'selected' : ''}}>2 Wheeler</option>
                                        <option value="3 Wheeler" {{$delivery_edit->delivery_type == "3 Wheeler" ? 'selected' : ''}}>3 Wheeler</option>
                                    </select>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control mb-3" type="text" value="{{empty(old('no_of_delivery_boys'))?$delivery_edit->no_of_delivery_boys:old('no_of_delivery_boys')}}" name="no_of_delivery_boys" placeholder=""
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control mb-3" type="text" value="{{empty(old('gst_no'))?$delivery_edit->gst_no:old('gst_no')}} " name="gst_no" placeholder=""
                                        aria-label="default input example" >
                                </div>
                            ...
                            <td>
                                {{-- <form class="dropzone needsclick file-upload" id="demo-upload" action="/upload"> --}}
                                    <div class="dz-message needsclick">
                                        ...
                                        @if(!empty($delivery_edit->gst_certificate))
                                        <span class="file_name">
                                            <a href = "{{url($delivery_edit->gst_certificate)}}" download>
                                            {{$delivery_edit->gst_certificate}}
                                            </a>
                                            </span>
                                        @endif    
                                    </div>
                            ...
                            <td>
                                {{-- <form class="dropzone needsclick file-upload" id="demo-upload" action="/upload"> --}}
                                    <div class="dz-message needsclick">
                                        ...
                                        @if($delivery_edit->govt_certificate)
                                         <span class="file_name">
                                             <a href = "{{url($delivery_edit->govt_certificate)}}" download>
                                            {{$delivery_edit->govt_certificate}}
                                            </a>
                                        </span>
                                       @endif
                                    </div>
                            ...
                            <td>
                                {{-- <form class="dropzone needsclick file-upload" id="demo-upload" action="/upload"> --}}
                                    <div class="dz-message needsclick">
                                        ...
                                        @if($delivery_edit->business_certificate)
                                        <span class="file_name">
                                        <a href="{{ url($delivery->business_certificate) }}" download>
                                            {{ basename($delivery->business_certificate) }}
                                        </a>
                                        </span>
                                        @endif
                                    </div>
                            ...
                            <td>
                                ...
                                {{-- <form class="dropzone needsclick file-upload" id="demo-upload" action="/upload"> --}}
                                    <div class="dz-message needsclick">
                                        ...
                                        <img src="{{asset($delivery_edit->shop_photo)}}" style="display:{{ !empty($delivery_edit->shop_photo)   ? 'block' : 'none' }}" alt="" width="150px" height="150px">
                                    </div>
                                {{-- </form> --}}
                        ...
                        <table class="table table-bordered table-left" style="width:100%">
                            <tbody>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control mb-3" type="text" name="lat" placeholder=""
                                                aria-label="default input example" id="lat" value="{{empty(old('lat'))?$delivery_edit->lat : old('lat')}}">
                                        </div>
                                         <span class="lat"></span>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control mb-3" type="text" name="lang" placeholder=""
                                                aria-label="default input example" id="lang" value="{{empty(old('lang'))?$delivery_edit->lang : old('lang')}}">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control mb-3" type="text" name="landmark" value="{{empty(old('landmark'))?$delivery_edit->landmark:old('landmark')}} " placeholder=""
                                                aria-label="default input example" value="">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control mb-3" type="text" value="{{empty(old('area_sqft'))?$delivery_edit->area_sqft:old('area_sqft')}} " name="area_sqft" placeholder=""
                                                aria-label="default input example" >
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control mb-3" type="text" value="{{empty(old('storage_capacity'))?$delivery_edit->storage_capacity : old('storage_capacity')}}" name="storage_capacity" placeholder=""
                                                aria-label="default input example" >
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control mb-3" type="text"  value="{{empty(old('twenty_ltres_sold_now'))?$delivery_edit->twenty_ltres_sold_now:old('twenty_ltres_sold_now') }} "name="twenty_ltres_sold_now" placeholder=""
                                                aria-label="default input example">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control mb-3" type="text" value="{{empty(old('selling_jars_weekly'))?$delivery_edit->selling_jars_weekly:old('selling_jars_weekly')}}" name="selling_jars_weekly" placeholder=""
                                                aria-label="default input example">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control mb-3" type="text" value="{{empty(old('pet_bottle_sold_now'))?$delivery_edit->pet_bottle_sold_now:old('pet_bottle_sold_now')}}" name="pet_bottle_sold_now" placeholder=""
                                                aria-label="default input example" value="">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control mb-3" type="text" value="{{empty(old('delivery_range'))?$delivery_edit->delivery_range:old('delivery_range')}} " name="delivery_range" placeholder=""
                                                aria-label="default input example">
                                        </div>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control mb-3" type="text" name="additional_info" placeholder=""
                                                aria-label="default input example" value="{{empty(old('additional_info'))?$delivery_edit->additional_info: old('additional_info')}} ">
                                        </div>
                                     ...
                                     <div class="mb-3 select2-sm">
										...
										<select class="single-select" name="assign_sales_rep">
											...
											@foreach($sales_rep as $sale)
                                                <option value="{{$sale->id}}" {{$delivery_edit->assign_sales_rep  == $sale->id ? 'selected' :''}}>{{$sale->name}}</option>
                                            @endforeach
										</select>
									</div>
                                     ...
                                     <div class="mb-3 select2-sm">
										...
										<select class="single-select" name="assigned_distributor">
											...
											@foreach($distributors as $distributor)
                                                <option value="{{$distributor->id}}" {{$delivery_edit->assigned_distributor == $distributor->id ? 'selected' :''}}>{{$distributor->name}}</option>
                                            @endforeach
										</select>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-select me-2" name="status">
                                            <option value="">-select-</option>
                                            <option value="1" {{ $delivery_edit->status == '1' ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{ $delivery_edit->status == '0' ? 'selected' : '' }}>Inactive</option>
...
$(document).ready(function(){
    ...
    e.preventDefault();
     var form = $('#delivery_form')[0];
        ...
        $.ajax({
            url: "{{route('delivery_agent.update',$delivery_edit->id)}}",
            type:'POST',
              processData: false,
            contentType: false,
            data: formData,
            success: function(data) {
                window.location.href="{{url('delivery_agent')}}"
            },error: function (xhr) {
