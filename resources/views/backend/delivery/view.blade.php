      ...
      <div class="card-body">
        <table class="table table-bordered table-left" style="width:100%">
          ...
          <tr>
                ...
                <td>{{$delivery_view->user_id}}</td>
              </tr>
            <tr>
              <th>
                <h6><strong>Name of the Shop</strong></h6>
              </th>
              <td>{{$delivery_view->name_of_shop}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>Nature of the shop</strong></h6>
              </th>
              <td>{{$delivery_view->nature_of_shop}}</td>
            </tr>
            <tr>
                <th>
                  <h6><strong>Ownership Status</strong></h6>
                </th>
                <td>{{$delivery_view->ownership_type}}</td>
              </tr>
            <tr>
              <th>
                <h6><strong>Name of the owner</strong></h6>
              </th>
              <td>{{$delivery_view->name_of_owner}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>Contact No</strong></h6>
              </th>
              <td>{{$delivery_view->owner_contact_no}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>Email Id</strong></h6>
              </th>
              <td>{{$delivery_view->owner_email}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>Pincode</strong></h6>
              </th>
              <td>{{$delivery_view->pincode}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>Delivery facility</strong></h6>
              </th>
              <td>{{$delivery_view->delivery_type}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>No of delivery persons</strong></h6>
              </th>
              <td>{{$delivery_view->no_of_delivery_boys}}</td>
            </tr>
            <!-- <tr>
            ...
            <tr>
              ...
              <td>
              <form action="{{url('download_file').'/'.$delivery_view->id}}" method="GET">
                  @csrf
            ...
            <tr>
              ...
              <td><img src="{{asset($delivery_view->shop_photo)}}" alt="" width=150></td>
            </tr>
          </tbody>
        </table>
          ...
          <table class="table table-bordered table-left" style="width:100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    {{$delivery_view->assign_sales_rep}}
                </td>
              </tr>
              <tr>
                <th>
