                        ...
                        <table class="table table-bordered table-left" style="width:100%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="lang"  value="{{old('lang')}}" placeholder=""
                                                aria-label="default input example" >
                                        </div>
                                     ...
                                     <div class="mb-3 select2-sm">
										...
										<select class="single-select" name="assign_sales_rep">
											...
											@foreach($sales_rep as $sale)
                                                <option value="{{$sale->id}}" {{old('assign_sales_rep') ? 'selected' : ''}} >{{$sale->name}}</option>
                                            @endforeach
										</select>
                                     ...
                                     <div class="mb-3 select2-sm">
										...
										<select class="single-select" name="assigned_distributor">
											...
											@foreach($distributors as $distributor)
                                                <option value="{{$distributor->id}}" {{old('assigned_distributor') ? 'selected' : ''}}>{{$distributor->name}}</option>
                                            @endforeach
										</select>
    ...
    $(function() {
      $('#datetimepicker2').datetimepicker({
        ...
        $('#delivery_form').submit(function(e){
            ...
            $.ajax({
                url: "{{route('delivery_agent.store')}}",
                type:'POST',
                  processData: false,
                contentType: false,
                data: formData,
