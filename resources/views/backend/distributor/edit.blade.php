...
<div class="row">
                ...
                <table class="table table-bordered table-left" style="width:100%">
                    ...
                    <tbody>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" placeholder=""
                                        aria-label="default input example" value="{{empty(old('name_of_shop'))?$distributor_edit->name_of_shop : old('name_of_shop')}}" name="name_of_shop" >
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <!--<input class="form-control mb-3" type="text" value="{{$distributor_edit->nature_of_shop}} " placeholder=""-->
                                    <!--    aria-label="default input example" name="nature_of_shop" >-->
                                    
                                    <select class="form-select" name="nature_of_shop">
                                        <option value="">Select nature</option>
                                        <option value="Super Market" {{($distributor_edit->nature_of_shop || old('nature_of_shop')) == "Super Market" ? 'selected' : ''}} >Super Market</option>
                                        <option value="General Store" {{($distributor_edit->nature_of_shop || old('nature_of_shop')) == "General Store" ? 'selected' : ''}}>General Store</option>
                                        <option value="Bakery" {{$distributor_edit->nature_of_shop == "Bakery" ? 'selected' : ''}}>Bakery</option>
                                        <option value="Others" {{$distributor_edit->nature_of_shop == "Others" ? 'selected' : ''}}>Others</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"  name="ownership_type"
                                            id="flexRadioDefault1" value="Proprietorship"   {{ ($distributor_edit->ownership_type || old('ownership_type')) == 'Proprietorship' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"  name="ownership_type"
                                            id="flexRadioDefault2" value="Partnership" {{ $distributor_edit->ownership_type == 'Partnership' ? 'checked' : '' }}>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="{{empty(old('name_of_owner'))?$distributor_edit->name_of_owner : old('name_of_owner')}}"  name="name_of_owner" placeholder=""
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="{{empty(old('owner_contact_no'))?$distributor_edit->owner_contact_no :old('owner_contact_no') }} " name="owner_contact_no" placeholder=""
                                        aria-label="default input example" value="">
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="{{empty(old('owner_email'))?$distributor_edit->owner_email : old('owner_email')}} " name="owner_email" placeholder=""
                                        aria-label="default input example" value="">
                                </div>
                            ...
                            <td>
                                <div>
                                    <textarea class="form-control" type="text" placeholder=""
                                        aria-label="default input example" rows="3" name="full_address" cols="3">{{empty(old('full_address'))?$distributor_edit->full_address :old('full_address')}} </textarea>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="{{empty(old('pincode'))?$distributor_edit->pincode :old('pincode') }}" name="pincode" placeholder=""
                        ...
                        <!--    <td>-->
                        <!--        <div>-->
                        <!--            <input class="form-control" type="text" value="{{empty(old('aadhar_number'))?$distributor_edit->aadhar_number :old('aadhar_number')}}" name="aadhar" placeholder=""-->
                        <!--                aria-label="default input example" >-->
                        <!--        </div>-->
                        ...
                        <tr>
                            ...
                            <td>
                                    <!--<input class="form-control mb-3" type="text" value="{{$distributor_edit->delivery_type}} " name="delivery_type" placeholder=""-->
                                    <!--    aria-label="default input example" value="">-->
                                     
                                       <select class="form-select me-2" name="delivery_type">
                                        <option value="">Select facility</option>
                                        <option value="2 Wheeler" {{($distributor_edit->delivery_type || old('delivery_type'))== "2 Wheeler" ? 'selected' : ''}}>2 Wheeler</option>
                                        <option value="3 Wheeler" {{($distributor_edit->delivery_type || old('delivery_type') )== "3 Wheeler" ? 'selected' : ''}}>3 Wheeler</option>
                                    </select>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="{{empty(old('no_of_delivery_boys'))?$distributor_edit->no_of_delivery_boys:old('no_of_delivery_boys')}}" name="no_of_delivery_boys" placeholder=""
                                        aria-label="default input example" >
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="{{empty(old('gst_no'))?$distributor_edit->gst_no:old('gst_no')}}" name="gst_no" placeholder=""
                                        aria-label="default input example" >
                                </div>
                            ...
                            <td>
                                {{-- <form class="dropzone needsclick file-upload" id="demo-upload" action="/upload"> --}}
                                    <div class="dz-message needsclick">
                                        ...
                                        <input type="file" name="gst_certificate" id="" class="form-control" value="{{$distributor_edit->gst_certificate}}">
                                        <span class="file_name">{{!empty($distributor_edit->gst_certificate)?$distributor_edit->gst_certificate:''}}</span>
                            ...
                            <td>
                                {{-- <form class="dropzone needsclick file-upload" id="demo-upload" action="/upload"> --}}
                                    <div class="dz-message needsclick">
                                        ...
                                        <span class="file_name">{{!empty($distributor_edit->govt_certificate)?$distributor_edit->govt_certificate:''}}</span>
                                        <!--<span class="d-block">Upload File</span>-->
                                    </div>
                                {{-- </form> --}}
                        ...
                        <!--                <span class="file_name">{{!empty($distributor_edit->business_certificate)?$distributor_edit->business_certificate:''}}</span>-->
                                        <!--<span class="d-block">Upload File</span>-->
                        <!--            </div>-->
                        <!--        {{-- </form> --}}-->
                            ...
                            <td>
                                ...
                                {{-- <form class="dropzone needsclick file-upload" id="demo-upload" action="/upload"> --}}
                                    ...
                                    <div class="dz-message needsclick">
                                        ...
                                        <img src="{{asset($distributor_edit->shop_photo)}}" style="display:{{ !empty($distributor_edit->shop_photo)   ? 'block' : 'none' }}" alt="" width="150px" height="150px">
                                    </div>
                                {{-- </form> --}}
    ...
    <div class="col-xl-6 mx-auto">
        ...
        <div class="card">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="lat" placeholder=""
                                                aria-label="default input example" value="{{empty(old('lat'))?$distributor_edit->lat : old('lat')}}">
                                        </div>
                                        <span class="lat"></span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" placeholder=""
                                                aria-label="default input example" name="lang" value="{{empty(old('lang'))?$distributor_edit->lang : old('lang')}}">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="landmark" value="{{empty(old('landmark'))?$distributor_edit->landmark:old('landmark')}} " placeholder=""
                                                aria-label="default input example" value="">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" value="{{empty(old('area_sqft'))?$distributor_edit->area_sqft:old('area_sqft')}} " name="area_sqft" placeholder=""
                                                aria-label="default input example" >
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" value="{{empty(old('storage_capacity'))?$distributor_edit->storage_capacity : old('storage_capacity')}}" name="storage_capacity" placeholder=""
                                                aria-label="default input example" >
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text"  value="{{empty(old('twenty_ltres_sold_now'))?$distributor_edit->twenty_ltres_sold_now:old('twenty_ltres_sold_now') }} "name="twenty_ltres_sold_now" placeholder=""
                                                aria-label="default input example">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" value="{{empty(old('selling_jars_weekly'))?$distributor_edit->selling_jars_weekly:old('selling_jars_weekly')}}" name="selling_jars_weekly" placeholder=""
                                                aria-label="default input example">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" value="{{empty(old('pet_bottle_sold_now'))?$distributor_edit->pet_bottle_sold_now:old('pet_bottle_sold_now')}}" name="pet_bottle_sold_now" placeholder=""
                                                aria-label="default input example" value="">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" value="{{empty(old('delivery_range'))?$distributor_edit->delivery_range:old('delivery_range')}} " name="delivery_range" placeholder=""
                                                aria-label="default input example">
                                        </div>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" name="shop_started_at" type="date" placeholder=""
                                                aria-label="default input example" value="{{date_format($shop_started_at,"Y-m-d")}}">
                                        </div>
                                    ...
                                    <td>
                                        <div id="">
                                            <input class="form-control" type="date" name="agreement_date" placeholder=""
                                                aria-label="default input example" value="{{date_format($agreement_date,'Y-m-d')}}">
                                        </div>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="additional_info" placeholder=""
                                                aria-label="default input example" value="{{empty(old('additional_info'))?$distributor_edit->additional_info: old('additional_info')}} ">
                                        </div>
                                     ...
                                     <div class="select2-sm">
										...
										<select class="single-select" name="assign_sales_rep">
											...
											@foreach($sales_rep as $sale)
                                                <option value="{{$sale->id}}" {{($distributor_edit->assign_sales_rep || old('assign_sales_rep')) == $sale->id ? 'selected' :''}}>{{$sale->name}}</option>
                                            @endforeach
										</select>
         ...
         <!--                                       <option value="{{$distributor->id}}" {{($distributor_edit->assigned_distributor) == $distributor->id ? 'selected' :''}}>{{$distributor->name}}</option>-->
         <!--                                   @endforeach-->
									<!--	</select>-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-select me-2" name="status">
                                            <option value="">-select-</option>
                                            <option value="1" {{$distributor_edit->status == '1' ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{$distributor_edit->status == '0' ? 'selected' : '' }}>Inactive</option>
...
<script type="text/javascript">
    ...
    $('#distributor_form').submit(function(e){
            ...
            $.ajax({
                url: "{{route('distributor.update',$distributor_edit->id)}}",
                type:'POST',
                processData: false,
                contentType: false,
                data: formData,
                success: function(data) {
                    window.location.href="{{url('distributor')}}";
