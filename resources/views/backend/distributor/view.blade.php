      ...
      <div class="card-body">
        <table class="table table-bordered table-left" style="width:100%">
          ...
          <tr>
                ...
                <td>{{$distributor_view->user_id}}</td>
              </tr>
            <tr>
              <th>
                <h6><strong>Name of the Shop</strong></h6>
              </th>
              <td>{{$distributor_view->name_of_shop}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>Nature of the shop</strong></h6>
              </th>
              <td>{{$distributor_view->nature_of_shop}}</td>
            </tr>
            <tr>
                <th>
                  <h6><strong>Ownership Status</strong></h6>
                </th>
                <td>{{$distributor_view->ownership_type}}</td>
              </tr>
            <tr>
              <th>
                <h6><strong>Name of the owner</strong></h6>
              </th>
              <td>{{$distributor_view->name_of_owner}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>Contact No</strong></h6>
              </th>
              <td>{{$distributor_view->owner_contact_no}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>Email Id</strong></h6>
              </th>
              <td>{{$distributor_view->owner_email}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>Pincode</strong></h6>
              </th>
              <td>{{$distributor_view->pincode}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>Delivery facility</strong></h6>
              </th>
              <td>{{$distributor_view->delivery_type}}</td>
            </tr>
            <tr>
              <th>
                <h6><strong>No of delivery persons</strong></h6>
              </th>
              <td>{{$distributor_view->no_of_delivery_boys}}</td>
            </tr>
            <!-- <tr>
            ...
            <tr>
              ...
              <td>
                <form action="{{url('download_file').'/'.$distributor_view->id}}" method="GET">
                  @csrf
                  <input type="hidden" value="gst_registration" name="type">
                  <button type="submit" class="btn btn-outline-info download_file" data-id="{{$distributor_view->id}}"><i
            ...
            <tr>
              ...
              <td><img src="{{asset($distributor_view->shop_photo)}}" width="150px" height="150px" alt=""></td>
            </tr>
          </tbody>
        </table>
          ...
          <table class="table table-bordered table-left" style="width:100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{date_format($shop_started_at,'Y-m-d')}}</td>
              </tr>
              <tr>
                <th>
              ...
              <tr>
                ...
                <td>
                    {{date_format($agreement_date,'Y-m-d')}}
                </td>
              </tr>
              <tr>
                <th>
                ...
                <td>
                    {{$distributor_view->assign_sales_rep}}
                </td>
              </tr>
              <tr>
                <th>
                ...
                <td>
                    {{$distributor_view->additional_info}}
                </td>
              </tr>  </tbody>
          </table>
        </div>
