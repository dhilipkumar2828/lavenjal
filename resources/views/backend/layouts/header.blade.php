              ...
              <ul class="navbar-nav align-items-center">
               ...
               <li class="nav-item dropdown dropdown-large">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                  <div>
                    <span class="notify-badge notification_count">{{count(\App\Models\Notifications::where('status','read')->get())}}</span>
                ...
                <div class="dropdown-menu dropdown-menu-end p-0" style="width:30em;">
                 ...
                 <div class="header-message-list p-2">
                    ...
                    @if(count(\App\Models\Notifications::where('status','read')->get())>10)
              ...
              <li class="nav-item dropdown dropdown-large">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                  <div class="user-setting d-flex align-items-center gap-1">
                    ...
                    <div class="user-name d-none d-sm-block">{{!empty(auth()->user())?auth()->user()->name:(!empty(auth()->guard('salesreps')) ? auth()->guard('salesreps')->user()->name:'')}}</div>
                  </div>
                </a>
...
<aside class="sidebar-wrapper" data-simplebar="true">
     ...
     <li>
          ...
          <a href="javascript:;" class="has-arrow">
              ...
              <ul class="bg-light border-0">
                ...
                <li> <a href="{{url('/deliveryboy-order-list')}}"><i class="bi bi-arrow-right-short"></i>Delivery Partners Orders</a>
                </li>
     ...
     <li>
          ...
          <a href="javascript:;" class="has-arrow">
              ...
              <ul class="bg-light border-0">
                ...
                <li> <a href="{{url('/customer-order-report')}}"><i class="bi bi-arrow-right-short"></i>Customer  Reports</a>
                </li>
                <li> <a href="{{url('/retailer-order-report')}}"><i class="bi bi-arrow-right-short"></i>Retailer Reports</a>
                </li>
                <li> <a href="{{url('/deliveryboy-order-report')}}"><i class="bi bi-arrow-right-short"></i>Delivery Partners Reports</a>
                </li>
                <li> <a href="{{url('/distributor_report')}}"><i class="bi bi-arrow-right-short"></i>Distributor Reports</a>
                </li>
  ...
  @endif
      @if(!empty(auth()->guard('salesreps')->user()))
