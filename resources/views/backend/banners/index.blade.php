...
@section('content')
    ...
    <main class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <a class="btn btn-primary mb-3 mb-lg-0" href="{{ route('banner.create') }}">
                        ...
                        <table id="example" class="table table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                @foreach ($banners as $key => $banner)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td><img src="{{asset($banner->photo)}}" width=auto height=100/></td>
                                        <td><input type="checkbox" data-banner_id="{{$banner->id}}" class="banner_status" data-toggle="toggle" data-on="Active" data-off="In Active" data-onstyle="success" data-offstyle="danger"  {{$banner->status=='active' ? 'checked' : ''}} ></td>
                                        </td>
                                        <td>
                                            <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                       
                                                <a href="{{ route('banner.edit', $banner->id) }}"   data-bs-toggle="tooltip" data-bs-placement="bottom" class="bg-edit"
