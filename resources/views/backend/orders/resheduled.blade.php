...
<main class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="breadcrumb-title pe-3"> <span class="badge status-reshedule">Rescheduled</span></div>
        ...
        <div class="row g-3 align-items-center justify-content-between">
          ...
          <div class="alert border-0 bg-light-danger alert-dismissible fade show py-2">
            <div class="d-flex align-items-center  justify-content-center">
              <div class="ms-3">
                <div class="text-danger"><strong>The order has been rescheduled. Previous Order Id :
                    #0000</strong>
                </div>
              </div>
            </div>
            ...
            <div class="col commoncardheader">
              <div class="card border shadow-none">
                <div class="card-header">
                  <h6 class="mb"><i class="bi bi-person text-primary"></i> Delivery Boy</h6>
                </div>
 ...
 <div class="card border shadow-none bg-light radius-10">
                  <div class="card-body">
                    <div class="d-flex align-items-center m-2">
                      ...
                      <div class="ms-auto">
                        <span class="text-success"><strong>March 5, 2022</strong></span>
                      </div>
                    </div>
                  </div>
                </div>
