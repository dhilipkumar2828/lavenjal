                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link Processing active" id="ordertabs1" data-bs-toggle="tab" data-bs-target="#orders1" type="button" role="tab" aria-controls="home" aria-selected="true"> Order Place</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="ordertabs2" data-bs-toggle="tab" data-bs-target="#orders2" type="button" role="tab" aria-controls="profile" aria-selected="false">Processing</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="ordertabs3" data-bs-toggle="tab" data-bs-target="#orders3" type="button" role="tab" aria-controls="contact" aria-selected="false">Ongoing</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="ordertabs4" data-bs-toggle="tab" data-bs-target="#orders4" type="button" role="tab" aria-controls="delivery" aria-selected="false">Completed</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="ordertabs5" data-bs-toggle="tab" data-bs-target="#orders5" type="button" role="tab" aria-controls="delivery" aria-selected="false">Return</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="ordertabs6" data-bs-toggle="tab" data-bs-target="#orders6" type="button" role="tab" aria-controls="delivery" aria-selected="false">Resheduled</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="ordertabs7" data-bs-toggle="tab" data-bs-target="#orders7" type="button" role="tab" aria-controls="delivery" aria-selected="false">Canceled</button>
                            </li>
                            </ul>
                            <div class="tab-content mt-4" id="myTabContent">
                                ...
                                <!-- tabs 5 -->
                                <div class="tab-pane fade" id="orders5" role="tabpanel" aria-labelledby="ordertabs5">
                                            <div class="table-responsive">
                                                    ...
                                                    <tbody>
                                                                        ...
                                                                        <td><span class="">15.11.2022 / 6am- 8am</span></td>
                                                                            <td><a href="{{url('/canceled')}}"><span class="badge bg-light-danger status-return">Return </span></a></td>
                                                                            <td>
                                                                            <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                ...
                                <!-- tabs 6 -->
                                <div class="tab-pane fade" id="orders6" role="tabpanel" aria-labelledby="ordertabs6">
                                            <div class="table-responsive">
                                ...
                                <!-- tabs 7 -->
                                <div class="tab-pane fade" id="orders7" role="tabpanel" aria-labelledby="ordertabs7">
                                            <div class="table-responsive">
