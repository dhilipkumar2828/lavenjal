...
<main class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3 d-flex" style="white-space: nowrap">Order Invoice : #{{$order->order_id}}</div>
        <div class="breadcrumb-title pe-3"> <span class="badge badge status-ongoing">{{$order->status}}</span></div>

<form action="{{url('order_status')}}" method="post" class="d-flex mb-0" style="width: 100%; text-align: right">
    @csrf
        <div class="ms-auto">
        ...
        <div class="card-body p-0">
          ...
          <div class="row row-cols-1 row-cols-xl-3 row-cols-xxl-3">
                ...
                <div class="order-invoice card-body">
                  <div class="d-flex flex-column align-items-center gap-3">
                    ...
                    <div class="info">
                      ...
                      <p class="mb-2"><strong>Name</strong> : {{$customer->name}}
                      </p>
                      <p class="mb-2"><strong>Phone Number</strong> : {{$customer->phone}}</p>
                      <p class="mb-2"><strong>Email ID</strong> : {{$customer->email}}</p>
                      <p class="mb-2"><strong>Address</strong> : {{(!empty($address)?$address->address .' '.$address->city.' '.$address->state:"")}}</p>
                        <p class="mb-2"><strong>Lat</strong> : {{(!empty($address)?$address->lat:'')}}</p>      
                        
                        <p class="mb-2"><strong>Lang</strong> : {{(!empty($address)?$address->lang:'')}}</p>
                        ...
                        class="w-100"
                          ...
                          marginheight="0" 
                          marginwidth="0" 
                          src="https://maps.google.com/maps?q={{(!empty($address)?$address->lat:'')}},{{(!empty($address)?$address->lang:'')}}&hl=en&z=14&amp;output=embed"
                         >
                         </iframe>
                      ...
                      <!--   <a href="https://maps.google.com/maps?q='{{(!empty($address)?$address->lat:'')}}','{{(!empty($address)?$address->lang:'')}}'&hl=es;z=14&amp;output=embed" -->
            ...
            <div class="col commoncardheader">
              <div class="card border shadow-none">
                <div class="card-header">
                  <h6 class="mb"><i class="bi bi-truck text-success"></i> {{$order->user_type=="customer" ? "Delivery Partner":"Distributor"}}</h6>
                </div>
                <div class="order-invoice card-body">
                  <div class="d-flex flex-column gap-3">
                    ...
                    <div class="info agent">
                      ...
                      <p class="mb-2"><strong>Name</strong> : {{!empty($delivery_boy) ? $delivery_boy->name : ''}} 
                      </p>
                 
                      <p class="mb-2"><strong>Phone Number</strong> : {{!empty($delivery_boy) ? $delivery_boy->phone:''}}</p>
                      <p class="mb-2"><strong>Email ID</strong> : {{!empty($delivery_boy) ? $delivery_boy->email:''}}</p>
                            ...
                            @if(!empty($A_del))
                               ...
                               class="w-100"
                                  ...
                                  marginheight="0" 
                                  marginwidth="0" 
                                  src="https://maps.google.com/maps?q={{(!empty($A_del)?$A_del->lat:'')}},{{(!empty($A_del)?$A_del->lang:'')}}&hl=en&z=14&amp;output=embed"
                                 >
                                 </iframe>
                         
                         
                         <!--<a href="https://maps.google.com/maps?q='{{(!empty($A_del)?$A_del->lat:'')}}','{{(!empty($A_del)?$A_del->lang:'')}}'&hl=es;z=14&amp;output=embed" -->
                         <!--       style="color:#0000FF;text-align:left" -->
                         <!--       target="_blank"-->
                         <!--      >-->
            ...
            <!--  <div class="card border shadow-none">-->
            <!--    <div class="card-header">-->
            <!--      <h6 class="mb"><i class="bi bi-truck text-success"></i> {{$order->user_type=="customer" ? "Near by Delivery Partners":"Distributor"}}</h6>-->
            <!--    </div>-->
            <!--    <div class="order-invoice card-body">-->
            <!--      <div class="d-flex flex-column gap-3">-->
                  ...
                  <div class="row">
                    <div class="card col-lg-6 text-center shadow-none">
                      <div class="box-bg p-3 border h-100">
                        <img src="{{asset('backend/assets/images/icons/water-can.png')}}" class="mb-3" alt="logo icon">
                        <h6 class="mb-2 text-primary">Return Jar</h6>
                        <h6 class="mb-0">{{$order->returnablejar_qty}}</h6>
                      </div>
                    </div>
                    <div class="card col-lg-6 text-center shadow-none">
                      <div class="box-bg p-3 border h-100">
                        ...
                        <h6 class="mb-0">{{$order->delivery_date}}</h6>
                    ...
                    <div class="card col-lg-6 text-center shadow-none">
                      <div class="box-bg p-3 border h-100">
                        ...
                        <h6 class="mb-0">₹{{$order->deposit_amount}}</h6>
                      </div>
                    </div>
                    <!--<div class="card col-lg-6 text-center shadow-none">-->
                    <!--  <div class="box-bg p-3 border h-100">-->
                        ...
                        <tr>
                          ...
                          <td><a class="d-flex align-items-center gap-2 imgtable" href="#">
                              <div class="product-box">
                                <img src="{{asset($order_detail->product_image)}}" alt="">
                              </div>
                              <div>
                                <h6 class="mb-1 product-title fw-bold">{{$order_detail->product_name}}</h6>
                ...
                <div class="card border shadow-none bg-light radius-10">
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-3">
                      ...
                      <div class="ms-auto">
                        <h5 class="ms-auto">₹{{ number_format($subtotal,2,'.','') }}</h5>
                      </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                      <div>
                        ...
                        <h5 class="ms-auto">₹{{ number_format($order->deposit_amount,2,'.','') }}</h5>
                      </div>
                    ...
                    <div class="d-flex align-items-center mb-3">
                      ...
                      <div class="ms-auto">
                        <h5 class="mb-0 text-danger">₹{{ number_format($order->deliver_charge,2,'.','') }}</h5>
                      </div>
                    ...
                    <div class="d-flex align-items-center mb-3">
                      ...
                      <div class="ms-auto">
                        <h5 class="mb-0 text-danger"> - ₹{{ number_format($order->discount_amount,2,'.','') }}</h5>
                      </div>
                    ...
                    <div class="d-flex align-items-center mb-3">
                      ...
                      <div class="ms-auto">
                        <h5 class="mb-0 text-danger">₹{{ number_format($order->total,2,'.','') }}</h5>
                      </div>
                     </div>
                    </div>
                  </div>
      ...
      <table class="table table-bordered table-left bg-white" style="width:100%;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{!empty($delivery_boy) ? $delivery_boy->name:''}}
              <!-- <Span>-</Span> -->
            </td>
          </tr>
          <tr>
