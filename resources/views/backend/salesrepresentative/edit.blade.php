    ...
    <main class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                <form action="{{ route('sales-representative.update', $sales_edit->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="name" value="{{ $sales_edit->name }}"
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="phone" value="{{ $sales_edit->phone }}"
                                placeholder="" aria-label="default input example">
                            @error('phone')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="email" value="{{ $sales_edit->email }}"
                                placeholder="" aria-label="default input example">
                            @error('email')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input class="form-control" type="file" name="image" placeholder=""
                                ...
                                @if(!empty($sales_edit->image))
                            <img src="{{ asset($sales_edit->image) }}" alt="" width="150px" height="150px">
                            @endif
                            @error('image')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <select class="form-select me-3" name="status">
                                ...
                                <option value="1" {{ $sales_edit->status == '1' ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ $sales_edit->status == '0' ? 'selected' : '' }}>Inactive</option>
                            </select>
                            @error('status')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
