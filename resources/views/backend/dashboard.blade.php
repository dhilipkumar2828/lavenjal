                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="">
                          ...
                          <h4 class="mb-0 text-primary">{{count(\App\Models\Product::where('status','active')->get())}}</h4>
                        </div>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="">
                          ...
                          <h4 class="mb-0 text-success">{{count(\App\Models\User::where('user_type','customer')->get())}}</h4>
                        </div>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="">
                          ...
                          <h4 class="mb-0 text-pink">{{count(\App\Models\User::where('user_type','retailer')->get())}}</h4>
                        </div>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="">
                          ...
                          <h4 class="mb-0 text-orange">{{count(\App\Models\User::where('user_type','delivery_agent')->get())}}</h4>
                        </div>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="">
                          ...
                          <h4 class="mb-0 text-pink">{{count(\App\Models\User::where('user_type','distributor')->get())}}</h4>
                        </div>
                        <div class="ms-auto fs-2 text-pink">
                          <i class="bi bi-bag-check"></i>
                        </div>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="">
                          ...
                          <h4 class="mb-0 text-orange">{{count(\App\Models\Order::get())}}</h4>
                        </div>
                        <div class="ms-auto fs-2 text-orange">
