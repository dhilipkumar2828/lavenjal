...
<body>
  ...
  <!--start content-->
    ...
    <!--                          <img src="{{url($product->image)}}" alt="product_img" width=auto height=100/>-->
    <!--                     </div>-->
    <!--                   </div>-->
    ...
    <section>
                ...
                <div class="row p-2">
                    ...
                    <div class="col-md-8 col-8">
                        <div class="product_details">
                            <h5>{{$product->name}}</h5>
                            <h6>Rs {{$product->customer_price}}/-</h6>
                            <div class="quantity">
                            <a href="#" class="quantity__minus" data-product_id="{{$product->id}}"><span>-</span></a>
                            <input name="quantity" type="tel" class="quantity__input quantity__input_{{$product->id}} numbers" value="{{ (!empty($cart) ? $cart->product_qty:1) }}" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}">
                            <input type="hidden" class="get_productQty_{{$product->id}}" value="{{ (!empty($cart) ? $cart->product_qty:1) }}">
                            <a href="#" class="quantity__plus" data-product_id="{{$product->id}}"><span>+</span></a>
                        </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <a class="btn reset_product" style="width: 100%; width: 100%;color: #3461ff;border: 1px solid;" data-product_id="{{$product->id}}">Clear</a>
                    </div>
                    <div class="col-6">
                        <a class="btn btn-primary add_to_cart" style="width: 100%; border: 1px solid;" data-user_id="{{$userid}}" data-product_id="{{$product->id}}" >Add to Cart</a>
                    </div>
                </div>
            </div>
            @endforeach
        ...
        <div class="container-fluid total-amount-section">
            <h5>Total Amount : Rs <span class="totalamount">{{$totalamount->price}}</span></h5>
        </div>
    </section>
