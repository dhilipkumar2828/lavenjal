<?php $__env->startSection('content'); ?>
   ...
   <main class="page-content cuustomerinfo">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">Add Delivery Partner</div>
              <div class="ms-auto">
                        ...
                        <table class="table table-bordered table-left" style="width:100%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="lang"  value="<?php echo e(old('lang')); ?>" placeholder=""
                                                aria-label="default input example" >
                                        </div>
                                     ...
                                     <div class="mb-3 select2-sm">
										...
										<select class="single-select" name="assign_sales_rep">
											...
											<?php $__currentLoopData = $sales_rep; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($sale->id); ?>" <?php echo e(old('assign_sales_rep') ? 'selected' : ''); ?> ><?php echo e($sale->name); ?></option>
                                     ...
                                     <div class="mb-3 select2-sm">
										...
										<select class="single-select" name="assigned_distributor">
											...
											<?php $__currentLoopData = $distributors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $distributor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($distributor->id); ?>" <?php echo e(old('assigned_distributor') ? 'selected' : ''); ?>><?php echo e($distributor->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										</select>
    ...
    $(function() {
      $('#datetimepicker2').datetimepicker({
        ...
        $('#delivery_form').submit(function(e){
            ...
            $.ajax({
                url: "<?php echo e(route('delivery_agent.store')); ?>",
                type:'POST',
                  processData: false,
                contentType: false,
                data: formData,
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lavenjalwaters/public_html/resources/views/backend/delivery/add.blade.php ENDPATH**/ ?>