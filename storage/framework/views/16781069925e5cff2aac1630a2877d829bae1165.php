...
<?php $__env->startSection('content'); ?>
   ...
   <main class="page-content cuustomerinfo">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">View Retailer</div>
<!--              <div class="ms-auto">-->
      ...
      <div class="card-body">
        <table class="table table-bordered table-left" style="width:100%">
          ...
          <tr>
                ...
                <td><?php echo e($retailer_view->user_id); ?></td>
              </tr>
            <tr>
              <th>
                <h6><strong>Name of the Shop</strong></h6>
              </th>
              <td><?php echo e($retailer_view->name_of_shop); ?></td>
            </tr>
            <!--<tr>-->
            <!--  <th>-->
            <!--    <h6><strong>Nature of the shop</strong></h6>-->
            <!--  </th>-->
            <!--  <td><?php echo e($retailer_view->nature_of_shop); ?></td>-->
            <!--</tr>-->
            <!--<tr>-->
            <!--    <th>-->
            <!--      <h6><strong>Ownership Status</strong></h6>-->
            <!--    </th>-->
            <!--    <td><?php echo e($retailer_view->ownership_type); ?></td>-->
            <!--  </tr>-->
            <tr>
              <th>
                <h6><strong>Name of the owner</strong></h6>
              </th>
              <td><?php echo e($retailer_view->name_of_owner); ?></td>
            </tr>
            <tr>
              <th>
                <h6><strong>Contact No</strong></h6>
              </th>
              <td><?php echo e($retailer_view->owner_contact_no); ?></td>
            </tr>
            <tr>
              <th>
                <h6><strong>Email Id</strong></h6>
              </th>
              <td><?php echo e($retailer_view->owner_email); ?></td>
            </tr>
            <tr>
              <th>
                <h6><strong>Pincode</strong></h6>
              </th>
              <td><?php echo e($retailer_view->pincode); ?></td>
            </tr>
                        <tr>
              <th>
              ...
              <td>
                 <?php if(!empty($retailer_view->business_certificate)): ?>
                <form action="<?php echo e(url('download_file').'/'.$retailer_view->id); ?>" method="GET">
                  <?php echo csrf_field(); ?>
                  <input type="hidden" value="business_certificate" name="type">
                <button type="submit" class="btn btn-outline-info download_file" data-id="<?php echo e($retailer_view->id); ?>"><i
            ...
            <!--  </th>-->
            <!--  <td><?php echo e($retailer_view->delivery_type); ?></td>-->
            <!--</tr>-->
            <!--<tr>-->
            <!--  <th>-->
            <!--    <h6><strong>No of delivery persons</strong></h6>-->
            <!--  </th>-->
            <!--  <td><?php echo e($retailer_view->no_of_delivery_boys); ?></td>-->
            <!--</tr>-->
            <!-- <tr>
            ...
            <!--  </th>-->
            <!--  <td><img src="<?php echo e(asset($retailer_view->shop_photo)); ?>" alt="" style="width:100%"></td>-->
            <!--</tr>-->
          </tbody>
        </table>
          ...
          <table class="table table-bordered table-left" style="width:100%">
            ...
            <tbody>
              <tr>
                ...
                <td><?php echo e($retailer_view->full_address); ?></td>
              </tr>
              <tr>
                <th>
                  <h6><strong>Landmark near the shop</strong></h6>
                </th>
                <td><?php echo e($retailer_view->landmark); ?></td>
              </tr>
              <tr>
                <th>
                  <h6><strong>Area of the shop in sq ft</strong></h6>
                </th>
                <td><?php echo e($retailer_view->area_sqft); ?></td>
              </tr>
              <tr>
                <th>
                  <h6><strong>Storage capacity of the water jars</strong></h6>
                </th>
                <td><?php echo e($retailer_view->storage_capacity); ?></td>
              </tr>
              <tr>
                <th>
                  <h6><strong>What brands of 20 Ltrs are sold now</strong></h6>
                </th>
                <td><?php echo e($retailer_view->twenty_ltres_sold_now); ?></td>
              </tr>
              <tr>
                <th>
                  <h6><strong>How many jars are being sold per week</strong></h6>
                </th>
                <td><?php echo e($retailer_view->selling_jars_weekly); ?></td>
              </tr>
              <tr>
                <th>
                  <h6><strong>What brands of pet bottles are sold now</strong></h6>
                </th>
                <td><?php echo e($retailer_view->pet_bottle_sold_now); ?></td>
              </tr>
              <!--<tr>-->
              <!--  <th>-->
              <!--    <h6><strong>How far can he deliver</strong></h6>-->
              <!--  </th>-->
              <!--  <td><?php echo e($retailer_view->delivery_range); ?></td>-->
              <!--</tr>-->
              <tr>
                <th>
              ...
              <tr>
                ...
                <td>
                    <?php echo e($retailer_view->assign_sales_rep); ?>
              ...
              <tr>
                ...
                <td>
                    <?php echo e($retailer_view->additional_info); ?>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lavenjalwaters/public_html/resources/views/backend/retailer/view.blade.php ENDPATH**/ ?>