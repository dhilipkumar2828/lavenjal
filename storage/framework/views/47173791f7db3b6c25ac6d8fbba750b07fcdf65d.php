<?php $__env->startSection('content'); ?>
   ...
   <main class="page-content cuustomerinfo">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">Add Distributor</div>
              <div class="ms-auto">
...
<div class="row">
    ...
    <form  enctype="multipart/form-data" id="distributor_form">
        <?php echo csrf_field(); ?>
                ...
                <table class="table table-bordered table-left" style="width:100%">
                    ...
                    <tbody>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" placeholder=""
                                        aria-label="default input example" value="<?php echo e(old('name_of_shop')); ?>" name="name_of_shop" >
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="<?php echo e(old('name_of_owner')); ?>"  name="name_of_owner" placeholder=""
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="<?php echo e(old('owner_contact_no')); ?>" name="owner_contact_no" placeholder=""
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="<?php echo e(old('owner_email')); ?>" name="owner_email" placeholder=""
                                        aria-label="default input example" value="">
                                </div>
                            ...
                            <td>
                                <div>
                                    <textarea class="form-control" type="text" placeholder=""
                                        aria-label="default input example" rows="3" name="full_address" cols="3"><?php echo e(old('full_address')); ?></textarea>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="<?php echo e(old('pincode')); ?>" name="pincode" placeholder=""
                        ...
                        <!--    <td>-->
                        <!--        <div>-->
                        <!--            <input class="form-control" type="text" value="<?php echo e(old('aadhar_number')); ?>" name="aadhar_number" placeholder=""-->
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="<?php echo e(old('gst_no')); ?>" name="gst_no" placeholder=""
                                        aria-label="default input example" >
                                </div>
                        ...
                        <!--<tr>-->
                        <!--    <th>-->
                        <!--        <h6><strong>Business certificate</strong></h6>-->
                        <!--    </th>-->
                        <!--    <td>-->
                        <!--        -->
                        <!--            <div class="dz-message needsclick">-->
    ...
    <div class="col-xl-6 mx-auto">
        ...
        <div class="card">
                        ...
                        <table class="table table-bordered table-left" style="width:100%">
                            <tbody>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="lat" placeholder=""
                                                aria-label="default input example" value="<?php echo e(old('lat')); ?>">
                                        </div>
                                       <span class="lat"></span>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="lang" placeholder=""
                                                aria-label="default input example"  value="<?php echo e(old('lang')); ?>">
                                        </div>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="landmark" placeholder=""
                                                aria-label="default input example" value="<?php echo e(old('landmark')); ?>">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" value="<?php echo e(old('area_sqft')); ?>" name="area_sqft" placeholder=""
                                                aria-label="default input example" >
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" value="<?php echo e(old('storage_capacity')); ?>" name="storage_capacity" placeholder=""
                                                aria-label="default input example" >
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text"  value="<?php echo e(old('twenty_ltres_sold_now')); ?>" name="twenty_ltres_sold_now" placeholder=""
                                                aria-label="default input example">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" value="<?php echo e(old('selling_jars_weekly')); ?>" name="selling_jars_weekly" placeholder=""
                                                aria-label="default input example">
                                        </div>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="pet_bottle_sold_now" placeholder=""
                                                aria-label="default input example" value="<?php echo e(old('pet_bottle_sold_now')); ?>">
                                        </div>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" name="shop_started_at" type="date" placeholder=""
                                                aria-label="default input example" value="<?php echo e(old('shop_started_at')); ?>">
                                        </div>
                                    ...
                                    <td>
                                        <div id="">
                                            <input class="form-control" type="date" name="agreement_date" placeholder=""
                                                aria-label="default input example" value="<?php echo e(old('agreement_date')); ?>">
                                        </div>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="additional_info" placeholder=""
                                                aria-label="default input example" value="<?php echo e(old('additional_info')); ?>">
                                        </div>
                                     ...
                                     <div class="mb-3 select2-sm">
										...
										<select class="single-select" name="assign_sales_rep">
											...
											<?php $__currentLoopData = $sales_rep; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($sale->id); ?>" <?php echo e(old('assign_sales_rep') == $sale->id ?'selected':''); ?> ><?php echo e($sale->name); ?></option>
         ...
         <!--                                       <option value="<?php echo e($distributor->id); ?>" <?php echo e(old('assign_sales_rep') == $distributor->id ?'selected':''); ?>><?php echo e($distributor->name); ?></option>-->
         <!--                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>-->
									<!--	</select>-->
    ...
    $(function() {
      $('#datetimepicker2').datetimepicker({
        ...
        $('#distributor_form').submit(function(e){
            ...
            $.ajax({
                url: "<?php echo e(route('distributor.store')); ?>",
                type:'POST',
                  processData: false,
                contentType: false,
                data: formData,
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lavenjalwaters/public_html/resources/views/backend/distributor/add.blade.php ENDPATH**/ ?>