              ...
              <div class="row g-0">
                ...
                <div class="col-12 col-xl-6 order-xl-2">
                  <div class="card-body p-5 p-sm-5">
                    ...
                    <form method="POST" action="<?php echo e(route('sales-loginsubmit')); ?>">
                        <?php echo csrf_field(); ?>
                      
                        <div class="row g-3">
                          <div class="col-12">
                            <label for="inputEmailAddress" class="form-label mb-3">Phone Number</label>
...
unset($__errorArgs, $__bag); ?> radius-30 ps-5" name="phone" value="<?php echo e(old('phone')); ?>" required autocomplete="phone" autofocus placeholder="Phone">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lavenjal/resources/views/backend/salesrepresentative/login.blade.php ENDPATH**/ ?>