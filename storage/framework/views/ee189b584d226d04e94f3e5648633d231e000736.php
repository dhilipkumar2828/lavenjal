                    ...
                    <table id="example" class="table table-bordered" style="width:100%">
                        ...
                        <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><input type="checkbox" data-city_id="<?php echo e($city->id); ?>" data-name="Pincode" class="city_status" data-toggle="toggle" data-on="Active" data-off="In Active" data-onstyle="success" data-offstyle="danger"  <?php echo e($city->status=='active' ? 'checked' : ''); ?> ></td>
                  
                                <td>
                                
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
       
                                        <a href="<?php echo e(url('city_edit',$city->id)); ?>" class="text-warning"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i
                                                class="bi bi-pencil-fill bg-edit" data-bs-toggle="modal"></i></a>
                                        <form action="<?php echo e(url('city_destroy',$city->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lavenjalwaters/public_html/resources/views/backend/city/index.blade.php ENDPATH**/ ?>