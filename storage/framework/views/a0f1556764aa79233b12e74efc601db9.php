                ...
                <div class="dropdown-menu dropdown-menu-end p-0" style="width:30em;">
                 ...
                 <div class="header-message-list p-2">
                    ...
                    <span class="notification_render">
                        <?php echo $__env->make('backend.notifications', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </span>
...
<!--end sidebar -->
<?php /**PATH C:\xampp\htdocs\lavenjalWeb-admin\resources\views/backend/layouts/header.blade.php ENDPATH**/ ?>