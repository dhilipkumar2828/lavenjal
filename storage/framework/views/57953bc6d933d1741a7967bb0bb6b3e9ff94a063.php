                            ...
                            <td>
                                <div>
                                    ...
                                    <select class="form-control" name="nature_of_shop">
                                        ...
                                        <option value="Super Market" <?php echo e($delivery_edit->nature_of_shop == "Super Market" ? 'selected' : ''); ?> >Super Market</option>
                                        <option value="General Store" <?php echo e($delivery_edit->nature_of_shop == "General Store" ? 'selected' : ''); ?>>General Store</option>
                                ...
                                <div>
                                    ...
                                    <!--    aria-label="default input example" value="">-->
                                       ...
                                       <select class="form-control" name="delivery_type">
                                        ...
                                        <option value="2 Wheeler" <?php echo e($delivery_edit->delivery_type == "2 Wheeler" ? 'selected' : ''); ?>>2 Wheeler</option>
                                        <option value="3 Wheeler" <?php echo e($delivery_edit->delivery_type == "3 Wheeler" ? 'selected' : ''); ?>>3 Wheeler</option>
                                    </select>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <div class="dz-message needsclick">
                                        ...
                                        <?php if(!empty($delivery_edit->gst_certificate)): ?>
                                        <span class="file_name">
                                            <a href = "<?php echo e(url($delivery_edit->gst_certificate)); ?>" download>
                                            <?php echo e($delivery_edit->gst_certificate); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <div class="dz-message needsclick">
                                        ...
                                        <?php if($delivery_edit->govt_certificate): ?>
                                         <span class="file_name">
                                             <a href = "<?php echo e(url($delivery_edit->govt_certificate)); ?>" download>
                                            <?php echo e($delivery_edit->govt_certificate); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <div class="dz-message needsclick">
                                        ...
                                        <?php if($delivery_edit->business_certificate): ?>
                                        <span class="file_name">
                                        <a href="<?php echo e(url($delivery->business_certificate)); ?>" download>
                                            <?php echo e(basename($delivery->business_certificate)); ?>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lavenjalwaters/public_html/resources/views/backend/delivery/edit.blade.php ENDPATH**/ ?>