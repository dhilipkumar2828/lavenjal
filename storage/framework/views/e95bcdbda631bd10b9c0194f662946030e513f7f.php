...
<?php $__env->startSection('content'); ?>
   ...
   <main class="page-content cuustomerinfo">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">Edit Retailer</div>
              <div class="ms-auto">
            ...
            <div class="card-body">
                <table class="table table-bordered table-left" style="width:100%">
                    ...
                    <tbody>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" placeholder=""
                                        aria-label="default input example" value="<?php echo e(empty(old('name_of_shop'))?$retailer_edit->name_of_shop : old('name_of_shop')); ?>" name="name_of_shop" >
                        ...
                        <!--    <td>-->
                        <!--        <div>-->
                                    <!--<input class="form-control mb-3" type="text" value="<?php echo e(old('nature_of_shop')); ?>" placeholder=""-->
                                    <!--    aria-label="default input example" name="nature_of_shop" >-->
                                    
                        <!--                                                <select class="form-select" name="nature_of_shop">-->
                        <!--                <option value="">Select nature</option>-->
                        <!--                <option value="Super Market" <?php echo e(old('nature_of_shop') == "Super Market" ? 'selected' : ''); ?>>Super Market</option>-->
                        <!--                <option value="General Store" <?php echo e(old('nature_of_shop') == "General Store" ? 'selected' : ''); ?>>General Store</option>-->
                        <!--                <option value="Bakery" <?php echo e(old('nature_of_shop') == "Bakery" ? 'selected' : ''); ?>>Bakery</option>-->
                        <!--                <option value="Others" <?php echo e(old('nature_of_shop') == "Others" ? 'selected' : ''); ?>>Others</option>-->
                        <!--            </select>-->
                        <!--        </div>-->
                        ...
                        <!--                    id="flexRadioDefault1" value="Proprietorship" <?php echo e(old('ownership_type') == 'Proprietorship' ? 'checked' : ''); ?>>-->
                        <!--                    -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="<?php echo e(empty(old('name_of_owner'))?$retailer_edit->name_of_owner : old('name_of_owner')); ?>"  name="name_of_owner" placeholder=""
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control " type="text" value="<?php echo e(empty(old('owner_contact_no'))?$retailer_edit->owner_contact_no : old('owner_contact_no')); ?>" name="owner_contact_no" placeholder=""
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="<?php echo e(empty(old('owner_email'))?$retailer_edit->owner_email : old('owner_email')); ?>" name="owner_email" placeholder=""
                                        aria-label="default input example" value="">
                                </div>
                            ...
                            <td>
                                <div>
                                    <textarea class="form-control" type="text" placeholder=""
                                        aria-label="default input example" rows="3" name="full_address" cols="3"><?php echo e(empty(old('full_address'))?$retailer_edit->full_address : old('full_address')); ?></textarea>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="<?php echo e(empty(old('pincode'))?$retailer_edit->pincode : old('pincode')); ?>" name="pincode" placeholder=""
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="<?php echo e(empty(old('aadhar_number'))?$retailer_edit->aadhar_number : old('aadhar_number')); ?>" name="aadhar_number" placeholder=""
                                        aria-label="default input example" onkeypress="return isNumber(event)" >
                                </div>
                        ...
                        <!--    <td>-->
                        <!--        <div>-->
                                    <!--<input class="form-control mb-3" type="text" value="<?php echo e(old('delivery_type')); ?>" name="delivery_type" placeholder=""-->
                                    <!--    aria-label="default input example" value="">-->
                        <!--            <select class="form-select" name="delivery_type">-->
                        <!--                <option value="">Select facility</option>-->
                        <!--                <option value="2 Wheeler" <?php echo e(old('delivery_type') == "2 Wheeler" ? 'selected' : ''); ?>>2 Wheeler</option>-->
                        <!--                <option value="3 Wheeler" <?php echo e(old('delivery_type') == "3 Wheeler" ? 'selected' : ''); ?>>3 Wheeler</option>-->
                        <!--            </select>-->
                        <!--        </div>-->
                        ...
                        <!--    <td>-->
                        <!--        <div>-->
                        <!--            <input class="form-control" type="text" value="<?php echo e(old('no_of_delivery_boys')); ?>" name="no_of_delivery_boys" placeholder=""-->
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control" type="text" value="<?php echo e(empty(old('gst_no'))?$retailer_edit->gst_no : old('gst_no')); ?>" name="gst_no" placeholder=""
                                        aria-label="default input example" >
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e(!empty($retailer_edit->business_certificate)?url($retailer_edit->business_certificate):''); ?>">
                                  <span class="file_name m-5">View file</span>
                                  </a>
                                 <!--<span class="file_name"><?php echo e(!empty($retailer_edit->business_certificate)?$retailer_edit->business_certificate:''); ?></span>-->
                            </td>
                        </tr>
                        <!--<tr>-->
                        <!--    <th>-->
                        ...
                        <table class="table table-bordered table-left" style="width:100%">
                            <tbody>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="lat" placeholder=""
                                                aria-label="default input example" value="<?php echo e(empty(old('lat'))?$retailer_edit->lat : old('lat')); ?>">
                                        </div>
                                       <span class="lat"></span>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="lang" placeholder=""
                                                aria-label="default input example" value="<?php echo e(empty(old('lang'))?$retailer_edit->lang : old('lang')); ?>">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="landmark" placeholder=""
                                                aria-label="default input example" value="<?php echo e(empty(old('landmark'))?$retailer_edit->landmark : old('landmark')); ?>">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" value="<?php echo e(empty(old('area_sqft'))?$retailer_edit->area_sqft : old('area_sqft')); ?>" name="area_sqft" placeholder=""
                                                aria-label="default input example" >
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" value="<?php echo e(empty(old('storage_capacity'))?$retailer_edit->storage_capacity : old('storage_capacity')); ?>" name="storage_capacity" placeholder=""
                                                aria-label="default input example" >
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text"  value="<?php echo e(empty(old('twenty_ltres_sold_now'))?$retailer_edit->twenty_ltres_sold_now : old('twenty_ltres_sold_now')); ?>" name="twenty_ltres_sold_now" placeholder=""
                                                aria-label="default input example">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" value="<?php echo e(empty(old('selling_jars_weekly'))?$retailer_edit->selling_jars_weekly : old('selling_jars_weekly')); ?>" name="selling_jars_weekly" placeholder=""
                                                aria-label="default input example">
                                        </div>
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="pet_bottle_sold_now" placeholder=""
                                                aria-label="default input example" value="<?php echo e(empty(old('pet_bottle_sold_now'))?$retailer_edit->pet_bottle_sold_now : old('pet_bottle_sold_now')); ?>">
                                        </div>
                                ...
                                <!--    <td>-->
                                <!--        <div>-->
                                <!--            <input class="form-control" type="text" value="<?php echo e(old('delivery_range')); ?>" name="delivery_range" placeholder=""-->
                                <!--                aria-label="default input example">-->
                                <!--        </div>-->
                                    ...
                                    <td>
                                        <div>
                                            <input class="form-control" type="text" name="additional_info" placeholder=""
                                                aria-label="default input example" value="<?php echo e(empty(old('additional_info'))?$retailer_edit->additional_info : old('additional_info')); ?>">
                                        </div>
                                ...
                                <tr>
									...
									<select class="single-select" name="assign_sales_rep">
											...
											<?php $__currentLoopData = $sales_rep; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($sale->id); ?>" <?php echo e(($retailer_edit->assign_sales_rep  == $sale->id || old('assign_sales_rep') == $sale->id) ? 'selected' :''); ?>><?php echo e($sale->name); ?></option>
                                ...
                                <tr>
									...
									<select class="single-select" name="assigned_distributor">
											...
											<?php $__currentLoopData = $distributors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $distributor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($distributor->id); ?>" <?php echo e($retailer_edit->assigned_distributor == $distributor->id ? 'selected' :''); ?>><?php echo e($distributor->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										</select>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <select class="form-select me-2" name="status">
                                            <option value="">-select-</option>
                                            <option value="1" <?php echo e($retailer_edit->status == '1' ? 'selected' : ''); ?>>Active</option>
                                            <option value="0" <?php echo e($retailer_edit->status == '0' ? 'selected' : ''); ?>>Inactive</option>
...
<script type="text/javascript">
            ...
            $.ajax({
                url: "<?php echo e(route('retailer.update',$retailer_edit->id)); ?>",
                type:'POST',
                  processData: false,
                contentType: false,
                data: formData,
                success: function(data) {
                    // custom_noty("success", "Order placed successfully");
...
<!--</script>-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lavenjalwaters/public_html/resources/views/backend/retailer/edit.blade.php ENDPATH**/ ?>