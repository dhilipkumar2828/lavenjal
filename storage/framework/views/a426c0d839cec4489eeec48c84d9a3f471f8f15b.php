            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                                              <div class="row">
                        <div class="col-3">
                          <h6 class="mb">Retailer Report</h6>
                        </div>
                        <div class="col-9">
                           <form action="<?php echo e(url('get_retailer_data')); ?>" class="d-flex justify-content-end"  method="POST">
                               <?php echo csrf_field(); ?>
                               <div class="m-1">
                               ...
                               <div class="d-flex  align-items-end">
                                   <button type="button" class="btn btn-secondary m-1 search_data" data-user_type="retailer">Filter</button>
                                ...
                                <!-- tabs 1 -->
                                    <div class="tab-pane fade show Processing active" id="orders1" role="tabpanel" aria-labelledby="ordertabs1">
                                            ...
                                            <div class="table-responsive table_render">
                                                <?php echo $__env->make('backend.reports.retailer_table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lavenjalwaters/public_html/resources/views/backend/reports/retailer.blade.php ENDPATH**/ ?>