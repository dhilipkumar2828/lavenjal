...
<?php $__env->startSection('content'); ?>
    ...
    <main class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <a class="btn btn-primary mb-3 mb-lg-0" href="<?php echo e(url('products/create')); ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="d-flex align-items-center gap-2 imgtable">
                                                ...
                                                <div>
                                                    <h6 class="mb-0 product-title fw-bold"><?php echo e($product->name); ?> </h6>
                                                </div>
                                            </a>
                                        </td>
                                        <td><?php echo e($product->size); ?></td>
                                        <td><?php echo e($product->customer_price); ?></td>
                                        <td><?php echo e($product->retailer_price); ?></td>
                                        <td><?php echo e($product->orderby); ?></td>
                                        <td><span class="badge  <?php echo e($product->status=='active' ?'bg-light-success text-success' : 'bg-light-danger text-danger'); ?>"><?php echo e($product->status=='active' ?'Active':'Inactive'); ?></span>
                                        </td>
                                        <td>
                                            <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                                <a data-id="<?php echo e($product->id); ?>" class="bg-view product_view"
                                                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="View"><i
                                                        class="bi bi-eye-fill" data-bs-toggle="modal"></i></a>
                                                <a href="<?php echo e(route('products.edit', $product->id)); ?>" class="bg-edit"
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mithra/Downloads/lavenjal_backup/resources/views/backend/product/index.blade.php ENDPATH**/ ?>