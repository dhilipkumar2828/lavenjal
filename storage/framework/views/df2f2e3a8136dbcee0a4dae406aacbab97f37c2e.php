    ...
    <main class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                <form action="<?php echo e(route('sales-representative.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lavenjalwaters/public_html/resources/views/backend/salesrepresentative/add-sales-representative.blade.php ENDPATH**/ ?>